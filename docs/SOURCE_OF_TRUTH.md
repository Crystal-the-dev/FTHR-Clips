...
| Outstanding release blocker | AUDIT-013 is resolved: PySide6/LGPL and all bundled assets are notice- and hash-gated. Remaining release gaps are operational/runtime items in `RELEASE_CHECKLIST.md`. |
